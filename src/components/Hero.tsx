        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center">
                <div className="flex">
                    ...
                    <motion.h1
                        className="font-cinzel text-4xl md:text-6xl font-light text-black text-center"
                        initial="hidden"
                        animate={controls}
                    ...
                    {/* Animating 'Gopeshwar' */}
                    <motion.h1
                        className="font-cinzel text-4xl md:text-6xl font-light text-[#578e7e] text-center ml-4 border-t-2 border-[#578e7e]"
                        initial="hidden"
                        animate={controls}
                        variants={{
                            hidden: { opacity: 0, y: 50 },
                ...
                <div className="space-x-64 flex mt-8">
                    {/* Static Buttons */}
                    {/* Contact Us Button */}
                    <div className="relative group">
                        <button className="relative border-2 border-[#545454] px-12 py-3 rounded-full overflow-hidden text-[#545454] font-glacial font-bold text-xl hover:text-white hover:border-white transition-all duration-300">
